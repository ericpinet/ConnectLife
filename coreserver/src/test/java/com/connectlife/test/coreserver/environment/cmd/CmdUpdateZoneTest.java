...
public class CmdUpdateZoneTest {
	...
	public void testNullRoom() {
		CmdUpdateRoom cmd = CmdFactory.getCmdUpdateRoom(null);
		try {
			cmd.execute();
			fail();
		} catch (Exception e) {
	...
	@Test
	public void testWithoutUidRoom() {
		CmdUpdateRoom cmd = CmdFactory.getCmdUpdateRoom(new Room(null, null));
		try {
			cmd.execute();
			fail();
		} catch (Exception e) {
		...
		CmdUpdateRoom cmd2 = CmdFactory.getCmdUpdateRoom(new Room("", null));
		try {
			cmd2.execute();
			fail();
		} catch (Exception e) {
	...
	public void testNotFound() {
		...
		CmdUpdateRoom cmd = CmdFactory.getCmdUpdateRoom(new Room("12345",""));
