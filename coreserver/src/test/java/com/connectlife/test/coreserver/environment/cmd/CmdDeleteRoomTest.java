...
public class CmdDeleteRoomTest {
	...
	public void testNullRoom() {
		CmdDeleteRoom cmd = CmdFactory.getCmdDeleteRoom(null);
		try {
			cmd.execute();
			fail();
		} catch (Exception e) {
	...
	public void testWithoutUidRoom() {
		CmdDeleteRoom cmd = CmdFactory.getCmdDeleteRoom(new Room(null, null));
		try {
			cmd.execute();
			fail();
		} catch (Exception e) {
		...
		CmdDeleteRoom cmd2 = CmdFactory.getCmdDeleteRoom(new Room("", null));
		try {
			cmd2.execute();
			fail();
		} catch (Exception e) {
	...
	public void testNotFound() {
		...
		CmdDeleteRoom cmd = CmdFactory.getCmdDeleteRoom(new Room("12345",""));
