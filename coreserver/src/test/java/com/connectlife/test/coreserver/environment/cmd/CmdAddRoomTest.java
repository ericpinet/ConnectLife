...
public class CmdAddRoomTest {
	...
	public void testNullZone() {
		...
		CmdAddRoom cmd = CmdFactory.getCmdAddRoom(	new Room(null, null), 
													null);
	...
	public void testNullRoom() {
		...
		CmdAddRoom cmd = CmdFactory.getCmdAddRoom(	null, 
													new Zone("12345", ""));
	...
	@Test
	public void testWithUidRoom() {
		
		CmdAddRoom cmd = CmdFactory.getCmdAddRoom(	new Room("123", null),
													new Zone("12345", ""));
	...
	public void testComplete() {
		...
		Node node_zone = Mockito.mock(Node.class);
		...
		try {			
			...
			Mockito.when(graph.findNode(Mockito.any(), Mockito.any(), Mockito.any())).thenReturn(node_zone);
		...
		CmdAddRoom cmd = CmdFactory.getCmdAddRoom( 	new Room("", null), 
													new Zone("12345",""));
