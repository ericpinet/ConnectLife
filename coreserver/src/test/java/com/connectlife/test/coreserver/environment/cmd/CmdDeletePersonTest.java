...
import com.connectlife.coreserver.environment.cmd.CmdDeletePerson;
...
public class CmdDeletePersonTest {
	...
	public void testWithoutUidPerson() {
		...
		CmdDeletePerson cmd2 = CmdFactory.getCmdDeletePerson(new Person("", null));
		try {
			cmd2.execute();
			fail();
		} catch (Exception e) {
	...
	public void testNotFound() {
		...
		CmdDeletePerson cmd = CmdFactory.getCmdDeletePerson(new Person("12345","","",""));
