...
public class CmdUpdateRoomTest {
	...
	public void testNullZone() {
		CmdUpdateZone cmd = CmdFactory.getCmdUpdateZone(null);
		try {
			cmd.execute();
			fail();
		} catch (Exception e) {
	...
	public void testWithoutUidZone() {
		CmdUpdateZone cmd = CmdFactory.getCmdUpdateZone(new Zone(null, null));
		try {
			cmd.execute();
			fail();
		} catch (Exception e) {
		...
		CmdUpdateZone cmd2 = CmdFactory.getCmdUpdateZone(new Zone("", null));
		try {
			cmd2.execute();
			fail();
		} catch (Exception e) {
	...
	public void testNotFound() {
		...
		CmdUpdateZone cmd = CmdFactory.getCmdUpdateZone(new Zone("12345",""));
