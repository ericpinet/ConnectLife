...
/**
 * Shell command for shutdown the system.
 * 
 * @author ericpinet
 * <br> 2016-02-07
 */
public class ShellCmdShutdown implements ShellCmd {
	 ...
	 * Shell command.
	 */
	private static final String SHELL_CMD = "shutdown";
