 ...
 * <br> 2016-02-07
 */
public class ShellCmdHelp implements ShellCmd {
	 ...
	 * Shell command.
	 */
	private static final String SHELL_CMD = "help";
	...
	public String execute(String _line) throws InterruptedIOException {
    	...
    	Iterator<ShellCmd> it = ShellCmdFactory.getCommands().iterator();
        while(it.hasNext()){
        	ShellCmd cmd = it.next();
        	response += cmd.getHelp();
        }
