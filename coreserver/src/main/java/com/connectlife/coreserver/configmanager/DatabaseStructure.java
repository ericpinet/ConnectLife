...
public class DatabaseStructure {
	...
	public static String[] CREATE_DATA(){
		String[] ret_strings = new String[ConfigSqliteManager.ItemConfig.length];
		...
		for(int i=0 ; i<ConfigSqliteManager.ItemConfig.length ; i++){
			
			ret_strings[i] = new String("insert into CONFIG values ('"+ ConfigSqliteManager.ItemConfig[i][column_config_section] +"',"
																 + "'"+ ConfigSqliteManager.ItemConfig[i][column_config_item] +"',"
																 + "'"+ ConfigSqliteManager.ItemConfig[i][column_config_type] +"',"
																 + "'"+ ConfigSqliteManager.ItemConfig[i][column_config_value] +"')");
		}
