			...
			<div class="col-md-4 col-md-offset-4">
	    		<div class="panel panel-default">
				  	<div class="panel-heading">
				    	<h3 class="panel-title">ConnectLife - Please sign in</h3>
				 	</div>
				  	<div class="panel-body">
				    	<form accept-charset="UTF-8" role="form">
	                    <fieldset>
				    	  	<div id="user-group" class="form-group">
				    		    <input id="user" class="form-control" placeholder="User" name="user" type="text">
				    		</div>
				    		...
				    		<input id="btn-login" class="btn btn-sm btn-primary btn-block" type="submit" value="Login">
				    	</fieldset>
				      	</form>
				      	<br>
