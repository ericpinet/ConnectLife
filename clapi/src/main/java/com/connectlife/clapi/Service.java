...
public class Service implements org.apache.thrift.TBase<Service, Service._Fields>, java.io.Serializable, Cloneable, Comparable<Service> {
  ...
  private static final org.apache.thrift.protocol.TField CHARACTERISTICS_FIELD_DESC = new org.apache.thrift.protocol.TField("characteristics", org.apache.thrift.protocol.TType.LIST, (short)2);
  ...
  public List<Characteristic> characteristics; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    UID((short)1, "uid"),
    CHARACTERISTICS((short)2, "characteristics");
  ...
  static {
    ...
    tmpMap.put(_Fields.CHARACTERISTICS, new org.apache.thrift.meta_data.FieldMetaData("characteristics", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Characteristic.class))));
  ...
  public Service(Service other) {
    ...
    if (other.isSetCharacteristics()) {
      List<Characteristic> __this__characteristics = new ArrayList<Characteristic>(other.characteristics.size());
      for (Characteristic other_element : other.characteristics) {
        __this__characteristics.add(new Characteristic(other_element));
      }
  ...
  public java.util.Iterator<Characteristic> getCharacteristicsIterator() {
    return (this.characteristics == null) ? null : this.characteristics.iterator();
  }

  public void addToCharacteristics(Characteristic elem) {
  ...
  public Service setCharacteristics(List<Characteristic> characteristics) {
    this.characteristics = characteristics;
    return this;
  }
  ...
  public void setCharacteristicsIsSet(boolean value) {
    if (!value) {
      this.characteristics = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CHARACTERISTICS:
      if (value == null) {
        ...
        setCharacteristics((List<Characteristic>)value);
      }
      break;
  ...
  public boolean equals(Service that) {
    ...
    boolean this_present_characteristics = true && this.isSetCharacteristics();
    boolean that_present_characteristics = true && that.isSetCharacteristics();
  ...
  public int hashCode() {
    ...
    boolean present_characteristics = true && (isSetCharacteristics());
  ...
  public int compareTo(Service other) {
    ...
    lastComparison = Boolean.valueOf(isSetCharacteristics()).compareTo(other.isSetCharacteristics());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (characteristics == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'characteristics' was not present! Struct: " + toString());
    }
  ...
  private static class ServiceStandardScheme extends StandardScheme<Service> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.characteristics = new ArrayList<Characteristic>(_list32.size);
                Characteristic _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new Characteristic();
                  _elem33.read(iprot);
                  struct.characteristics.add(_elem33);
                }
                iprot.readListEnd();
              }
              struct.setCharacteristicsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Service struct) throws org.apache.thrift.TException {
      ...
      if (struct.characteristics != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.characteristics.size()));
          for (Characteristic _iter35 : struct.characteristics)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ServiceTupleScheme extends TupleScheme<Service> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Service struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.uid);
      {
        ...
        for (Characteristic _iter36 : struct.characteristics)
        {
          _iter36.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Service struct) throws org.apache.thrift.TException {
      ...
      struct.setUidIsSet(true);
      {
        ...
        struct.characteristics = new ArrayList<Characteristic>(_list37.size);
        Characteristic _elem38;
        for (int _i39 = 0; _i39 < _list37.size; ++_i39)
        {
          _elem38 = new Characteristic();
          _elem38.read(iprot);
          struct.characteristics.add(_elem38);
        }
      }
      struct.setCharacteristicsIsSet(true);
    }
