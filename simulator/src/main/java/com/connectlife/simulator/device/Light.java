...
public class Light extends Device {
	 ...
	 * @param imageurl
	 */
	public Light(String label, String manufacturer, String model, String serialnumber, String imageurl) {
		super(label, manufacturer, model, serialnumber, imageurl, AccessoryType.LIGHT);
